...
RUN echo y | /opt/android-sdk/tools/android update sdk --all --filter platform-tools,build-tools-25.0.1,extra-android-m2repository --no-ui --force
RUN echo y | /opt/android-sdk/tools/android update sdk --all --filter sysimg-21,android-21 --no-ui --force
